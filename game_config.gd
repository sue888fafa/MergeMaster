...
const Readme := preload("res://readme.gd")
...
const FACTION_PLAYER_NAMES := {
	FACTION_PLAYER: Readme.FACTION_PLAYER_NAMES[FACTION_PLAYER],
	FACTION_RED: Readme.FACTION_PLAYER_NAMES[FACTION_RED],
	FACTION_PURPLE: Readme.FACTION_PLAYER_NAMES[FACTION_PURPLE],
	FACTION_GREEN: Readme.FACTION_PLAYER_NAMES[FACTION_GREEN]
}
...
const FATE_DIVINATION_ROLL_DURATION := 3.0
...
const QUESTION_CHEST_EFFECT_DURATION := 0.8
...
const MERCHANT_STORM_DURATION := 3.0
...
const BARRACKS_GARRISON_OFFSET := Vector2(0.0, -20.0)
const BARRACKS_GARRISON_SLOT_OFFSETS := [
	Vector2(0.0, 30.0),
	Vector2(-20.0, 12.0),
	Vector2(20.0, 12.0),
	Vector2(-20.0, -10.0),
