...
const WILD_MONSTER_MIN_COUNT := 5
const WILD_MONSTER_MAX_COUNT := 8
const RANDOM_TILE_TYPE_WEIGHT := 0.90
const FATE_TILE_TYPE_WEIGHT := 0.02
const BARRACKS_2_TILE_TYPE_WEIGHT := 0.02
const MINE_TILE_TYPE_WEIGHT := 0.02
const WILD_MONSTER_TILE_TYPE_WEIGHT := 0.03
const MERCHANT_TILE_TYPE_WEIGHT := 0.01
